...
<body>
  ...
  <main class="task-list-page">
    ...
    <form action="<%= request.getContextPath() %>/TaskUpdateEngine" method="post">
      ...
      <!-- ▼ カテゴリ -->
      <%
      java.util.List<model.TaskCategory> categoryList =
                  (java.util.List<model.TaskCategory>) request.getAttribute("categoryList");
      %>
      ...
      <select name="category_id" id="category_id">
          ...
          if (categoryList != null) {
                        for (model.TaskCategory c : categoryList) {
